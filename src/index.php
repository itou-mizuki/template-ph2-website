...
<body>
  ...
  <main class="l-main">
    ...
    <div class="p-quiz-container l-container">
        ...
        <div class="p-quiz-box__answer">
          ...
          <ul class="p-quiz-box__answer__list">
            <li class="p-quiz-box__answer__item">
              <button class="p-quiz-box__answer__button js-answer" data-answer="0" data-correct="<?= $questions[$i]["choices"][0]["valid"] ? '1' : '0' ?>">
                <?= $questions[$i]["choices"][0]['name']; ?><i class="u-icon__arrow"></i>
              </button>
            </li>
            <li class="p-quiz-box__answer__item">
              <button class="p-quiz-box__answer__button js-answer" data-answer="1" data-correct="<?= $questions[$i]["choices"][1]["valid"] ? '1' : '0' ?>">
                <?= $questions[$i]["choices"][1]['name']; ?><i class="u-icon__arrow"></i>
              </button>
            </li>
            <li class="p-quiz-box__answer__item">
              <button class="p-quiz-box__answer__button js-answer" data-answer="2" data-correct="<?= $questions[$i]["choices"][2]["valid"] ? '1' : '0' ?>">
        ...
        <?php if ($questions[$i]["supplement"] !== null && $questions[$i]["supplement"] !== '') { ?>
...
<?php } ?>
  ...
  <!-- /.l-footer .p-footer -->
<script src="./assets/scripts/quiz.js" 
></script>
</body>
